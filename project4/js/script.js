loadData().then(data => {
    ...
    function updateCountry(country) {
        ...
        //that.activeCountry = country.country;
        that.activeCountry = country.id;

        console.log("updateCountry", country.id);
        worldMap.updateHighlightClick(country.id);

        gapPlot.updateHighlightClick(country); 
