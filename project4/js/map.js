...
class Map {
    ...
    drawMap(world) {
        ...
        //console.log("this,populationData:", this.populationData);
        ...
        let countryInfo = countryData.filter(f => f != null);
    ...
    updateHighlightClick(activeCountry) {
        ...
        let svg = d3.select("#map-chart").select("svg");
        activeCountry = "#"+activeCountry;
        let path_elem_of_country = svg.select(activeCountry)
    ...
    clearHighlight() {
        ...
        {
            let path_elem_of_country = svg.select(this.selectedCountry[i])
